...
class ServicePlatformController {
    ...
    static async getAllServices(req, res) {
        try {
            ...
            return res.status(500).json({ status: "error", error: "No se pudo recuperar la agenda de cultos." });
        }
    }
    ...
    static async getAllSchedule(req, res) {
        try {
            ...
            return res.status(500).json({ status: "error", error: "No se pudo recuperar el cronograma de cultos futuros." });
        }
    }
    ...
    static async getServiceById(req, res) {
        try {
            ...
            return res.status(500).json({ status: "error", error: "Error al recuperar los detalles del culto." });
        }
    }
    ...
    static async processCreateService(req, res) {
        try {
            ...
            return res.status(500).json({ status: "error", error: "Error interno al procesar el registro de los servicios." });
        }
    }
    ...
    static async processUpdateService(req, res) {
        try {
            ...
            return res.status(500).json({ status: "error", error: "Error interno al intentar actualizar el culto." });
        }
    }
    ...
    static async deleteService(req, res) {
        try {
            ...
            return res.status(500).json({ status: "error", error: "Error al intentar eliminar el culto." });
        }
    }
}
